...
def greet():
  print("Hello there and welcome to SkyRoute!")
...
def set_start_and_end(start_point,end_point):
  if start_point != None:
    change_point = input("What would you like to change?\n You can enter 'o' for 'origin', 'd' for 'destination', or 'b' for 'both': ").lower()
    if change_point == "b":
...
def show_landmarks():
  see_landmarks = input("Would you like to see a list of landmarks again? Enter y/n: ".lower())
  if see_landmarks == "y":
